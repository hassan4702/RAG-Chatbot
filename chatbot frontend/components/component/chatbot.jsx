...
* @see https://v0.dev/t/8N3PsQAalL6
      ...
      <div className="flex-col hidden gap-2 text-foreground bg-background md:flex">
        ...
        <div className="flex-1 overflow-auto">
          <div className="grid gap-1 p-2 text-foreground">
            <div className="px-2 text-xs font-medium text-muted-foreground">Recent Chats</div>
            <Link
              href="#"
          ...
          <div className="grid gap-1 p-2 text-foreground">
            <div className="px-2 text-xs font-medium text-muted-foreground">Settings</div>
            <Link
              href="#"
              className="flex-1 block p-2 overflow-hidden text-sm truncate transition-colors rounded-md whitespace-nowrap hover:bg-muted/50"
              prefetch={false}>
        ...
        <div className="flex flex-col items-start flex-1 max-w-2xl gap-8 px-4 mx-auto">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="grid gap-1">
              ...
              <div className="prose text-muted-foreground">
                <p>
                  Of course! Imagine you're in a car driving down a bumpy road, and the ride isn't perfectly smooth.
                  Sometimes, you hit small potholes or bumps, right? Well, when you're in an airplane, it's kind of like
                  that, but in the sky.
                </p>
                <p>
                  Airplane turbulence happens when the plane encounters pockets of air that are moving differently. It's
                  like sailing a boat on choppy water. These air pockets can make the plane feel like it's bouncing or
